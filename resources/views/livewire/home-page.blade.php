...
<div class="font-serif text-ink pb-12">
         ...
         <section class="max-w-screen-2xl mx-auto px-4 md:px-6 py-12">
             ...
             <div class="grid md:grid-cols-3 gap-8">
                 ...
                 <div class="group">
                     ...
                     <h3 class="text-xl font-bold leading-tight mb-2 group-hover:underline">
                         <a href="{{ route('post', $post->slug) }}" wire:navigate>{{ $post->title }}</a>
                     </h3>
                     <span class="text-[10px] text-neutral-500 font-sans block mt-1"><i class="fa-regular fa-clock mr-1"></i>{{ $post->created_at->format('M d, Y | H:i') }}</span>
                 </div>
                 @endforeach
             </div>
         </section>
    ...
    <section class="max-w-screen-2xl mx-auto px-4 md:px-6">
        ...
        <div class="grid md:grid-cols-3 gap-6">
            ...
            <div class="group">
                ...
                <h3 class="text-lg font-bold font-serif leading-tight mt-1 group-hover:underline">
                    <a href="{{ route('post', $post->slug) }}" wire:navigate>{{ $post->title }}</a>
                </h3>
                <span class="text-[10px] text-neutral-500 font-sans block mt-1"><i class="fa-regular fa-clock mr-1"></i>{{ $post->created_at->format('M d, Y | H:i') }}</span>
            </div>
    ...
    <section class="max-w-screen-2xl mx-auto px-4 md:px-6 py-8 md:py-12 border-b-4 border-double border-neutral-800">
        <div class="grid grid-cols-1 md:grid-cols-12 gap-8 lg:gap-12">
            ...
            <div class=" md:col-span-3 space-y-6 pr-0 md:pr-6 block mt-8 md:mt-0">
                <h2 class="font-sans-caption font-bold border-b border-black mb-2 pb-1">Top Headlines</h2>
                <div class="space-y-6">
                    ...
                    <article class="mb-6 group">
                        <div class="flex gap-3 mb-2">
                             ...
                             <div>
                                <span class="text-[9px] font-bold font-sans uppercase text-neutral-500 block mb-1">
                                    {{ $news->created_at->format('M d, Y | H:i') }} / {{ $news->source->name ?? 'Wire' }}
                                </span>
                                <h3 class="font-bold text-base leading-snug font-serif text-[#222] hover:text-accent-red cursor-pointer group-hover:underline line-clamp-2">
            ...
            <div class="order-1 md:order-2 md:col-span-6">
                ...
                <article>
                    ...
                    <div class="text-center md:px-4">
                        ...
                        <div class="flex items-center justify-center gap-2 mb-4 text-[10px] font-bold uppercase tracking-widest text-neutral-500 font-sans">
                            <span><i class="fa-regular fa-calendar-check mr-1"></i>{{ $main->created_at->format('M d, Y') }}</span>
                            <span>•</span>
                            <span><i class="fa-regular fa-clock mr-1"></i>{{ $main->created_at->format('H:i') }}</span>
                        </div>
            ...
            <div class="order-3 md:col-span-3 space-y-6 border-l border-neutral-200 md:border-none mt-8 md:mt-0">
                <div class=" md:pl-6 h-full"> 
                    <h2 class="font-sans-caption font-bold border-b border-black mb-4 pb-1">Popular & Recent</h2>
                    ...
                    <article class="mb-6 group">
                        <div class="flex gap-3 mb-2">
                             ...
                             <div>
                                <span class="text-[9px] font-bold font-sans uppercase text-neutral-500 block mb-1">
                                    {{ $post->category->name ?? 'News' }} • {{ $post->created_at->format('M d, Y | H:i') }}
                                </span>
                                <h3 class="font-bold text-base leading-snug font-serif text-[#222] group-hover:underline line-clamp-2">
                                    <a href="{{ route('post', $post->slug) }}" wire:navigate>{{ $post->title }}</a>
                                </h3>
                             </div>
                        </div>
                    ...
                    <div class="bg-paper-dark border border-black p-4 mt-8 text-center shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
                        <h3 class="font-sans-caption font-bold text-xs mb-2 text-ink">Subscribe to E-Paper</h3>
    ...
    <section class="container mx-auto px-4 md:px-6 py-8" x-data="{ 
        activeSlide: 0, 
        totalSlides: {{ $trendingPosts->count() }},
        ...
        <div class="flex items-center justify-between mb-4 border-l-4 border-accent-red pl-3">
             <h2 class="text-2xl font-black font-sans uppercase tracking-tight">Don't Miss</h2>
            ...
            <div class="flex transition-transform duration-500 ease-in-out" :style="'transform: translateX(-' + (activeSlide * 100) + '%)'">
                ...
                <div class="w-full shrink-0 flex flex-col md:flex-row gap-6 p-4 md:p-8 items-center">
                     ...
                     <div class="w-full md:w-1/2 space-y-4">
                         ...
                         <h2 class="text-2xl md:text-4xl font-black leading-none hover:underline decoration-accent-red decoration-4">
                             <a href="{{ route('post', $post->slug) }}" wire:navigate>{{ $post->title }}</a>
                         </h2>
                         ...
                         <div class="flex items-center gap-2 text-xs font-bold uppercase tracking-widest text-neutral-500">
                             ...
                             <span>•</span>
                             <span><i class="fa-regular fa-clock mr-1"></i>{{ $post->created_at->format('M d, Y | H:i') }}</span>
                         </div>
                     </div>
                </div>
                @endforeach
        ...
        <div class="max-w-screen-2xl mx-auto px-4 md:px-6">
            ...
            <div class="flex items-end justify-between mb-10 border-b-2 border-blue-900 pb-4 relative">
                 <div class="flex items-center gap-3">
                     ...
                     <h2 class="text-3xl md:text-4xl font-black font-serif text-blue-950 uppercase tracking-tight leading-none">
                        India <span class="text-amber-600">&</span> National
                     </h2>
                 </div>
                 <a href="{{ route('category', 'india') }}" class="hidden md:flex items-center gap-2 font-sans font-bold text-xs uppercase tracking-widest text-blue-900 hover:text-amber-600 transition-colors bg-white px-4 py-2 border border-blue-100 shadow-sm">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12">
                ...
                <div class="lg:col-span-7 group cursor-pointer lg:border-r lg:border-dashed lg:border-neutral-300 lg:pr-12">
                    <div class="relative mb-6">
                        ...
                        <div class="flex items-center gap-3 mb-2">
                             <span class="text-xs font-bold font-sans uppercase text-amber-600 tracking-wider"><i class="fa-solid fa-fire mr-1"></i> Trending Now</span>
                             <span class="text-xs font-serif text-neutral-500 italic">/ {{ $leadPost->created_at->format('M d, Y | H:i') }}</span>
                        </div>
                        
                        <h3 class="text-2xl md:text-4xl font-black font-serif leading-tight mb-3 text-blue-950 group-hover:text-blue-700 transition-colors">
                ...
                <div class="lg:col-span-7 flex items-center justify-center border border-dashed border-neutral-300 h-64">
                    <p class="text-neutral-400 font-bold uppercase tracking-widest">No Stories Available</p>
                </div>
                @endif
                
                <!-- Side Stories (Col span 5) -->
                <div class="lg:col-span-5 flex flex-col h-full bg-white border border-neutral-100 p-6 shadow-sm">
                    <h3 class="font-sans font-bold text-xs uppercase tracking-widest text-blue-900 border-b-2 border-amber-500 pb-2 mb-6 flex justify-between items-center">
                        ...
                        <div class="py-5 group flex gap-5 items-start first:pt-0 last:pb-0">
                             ...
                             <div class="flex-1">
                                 <div class="flex items-center gap-2 mb-1.5">
                                     <span class="text-[9px] font-bold uppercase text-amber-600 tracking-wider">{{ $post->category->name ?? 'Update' }}</span>
                                     <span class="text-[9px] text-neutral-400 font-sans">• {{ $post->created_at->format('M d | H:i') }}</span>
                                 </div>
    ...
    <section class="w-full bg-white py-12 border-b border-neutral-200">
        <div class="max-w-screen-2xl mx-auto px-4 md:px-6">
            <!-- Market Ticker Bar -->
            <div class="mb-8 border-y border-neutral-200 py-2 bg-neutral-50 rounded-sm">
            ...
            <div class="flex flex-col md:flex-row md:items-center justify-between mb-8 pb-2 border-b-2 border-green-700 gap-2 md:gap-0">
                <h2 class="text-2xl md:text-3xl font-black font-serif text-blue-950 uppercase tracking-tight flex items-center gap-3">
                    ...
                    Dalal Street <span class="text-amber-600">&</span> Economy
                </h2>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12">
                 ...
                 <div class="lg:col-span-8">
                     ...
                     <div class="group cursor-pointer">
                         <div class="aspect-video md:aspect-[2/1] border border-neutral-200 overflow-hidden mb-5 relative shadow-sm">
                             ...
                             <div class="absolute bottom-0 left-0 bg-white/95 backdrop-blur-sm p-6 max-w-2xl border-t-4 border-green-700">
                                 ...
                                 <h3 class="text-2xl md:text-4xl font-black font-serif text-blue-950 leading-tight mb-2 group-hover:underline decoration-green-700 decoration-2">{{ $trendingPosts->first()->title }}</h3>
                     ...
                     <div class="grid md:grid-cols-2 gap-6 mt-8 pt-8 border-t border-dashed border-neutral-300">
                        ...
                        <div class="flex gap-4 items-start group">
                            ...
                            <div>
                                <span class="text-[9px] font-bold text-neutral-400 uppercase mb-1 block">{{ $post->category->name }}</span>
                                <h4 class="text-lg font-bold font-serif leading-tight text-blue-950 mb-2 group-hover:text-green-700 transition">
                                    <a href="{{ route('post', $post->slug) }}" wire:navigate>{{ $post->title }}</a>
                                </h4>
                                <span class="text-xs font-bold text-green-600"><i class="fa-solid fa-caret-up"></i> Bullish • {{ $post->created_at->format('M d | H:i') }}</span>
                            </div>
                        </div>
                        @endforeach
                     </div>
                 ...
                 <div class="lg:col-span-4 bg-blue-50/50 p-6 border border-blue-100 rounded-sm">
                     <h3 class="font-sans font-bold text-xs uppercase tracking-widest text-blue-900 mb-5 border-b border-blue-200 pb-2">
                     ...
                     <div class="space-y-5">
                         ...
                         <div class="group border-b border-blue-100 pb-4 last:border-0 last:pb-0">
                             <div class="flex justify-between items-start mb-1">
                                <span class="text-[9px] font-bold text-blue-500 uppercase">{{ $post->created_at->format('M d | H:i') }}</span>
    ...
    <section class="container mx-auto px-4 md:px-6 py-12 border-t border-neutral-200 bg-neutral-50/50">
        <div class="flex items-center justify-between mb-8 border-b-2 border-red-600 pb-2">
             <div class="flex items-center gap-3">
                 ...
                 <h2 class="font-serif text-2xl md:text-4xl font-black uppercase tracking-tight text-blue-950">Sports Arena</h2>
             </div>
             <div class="flex gap-4 text-xs font-bold uppercase tracking-widest text-neutral-500 hidden md:flex">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
             ...
             <div class="lg:col-span-3">
                 ...
                 <div class="mt-6 bg-white border border-neutral-200 p-4 shadow-[3px_3px_0px_0px_rgba(0,0,0,1)]">
                     <h3 class="font-sans font-bold text-xs uppercase tracking-widest text-neutral-500 mb-3 border-b border-neutral-100 pb-2">Upcoming Matches</h3>
                     <ul class="space-y-3">
            ...
            <div class="lg:col-span-9">
                        ...
                        <div class="aspect-video relative overflow-hidden border border-black mb-0">
                            <span class="absolute top-0 right-0 bg-red-600 text-white px-3 py-1 text-xs font-bold uppercase tracking-widest z-10 animate-pulse">Live Action</span>
                             ...
                             <div class="absolute bottom-0 left-0 p-6 w-full">
                                 <h3 class="text-xl md:text-3xl font-bold font-serif text-white leading-none mb-2">{{ $sportMain->title }}</h3>
                                 <p class="text-neutral-200 line-clamp-2 font-serif text-sm w-5/6">{{ Str::limit(strip_tags($sportMain->content), 100) }}</p>
                                 <span class="text-[10px] font-bold text-white/60 uppercase tracking-widest mt-2 block"><i class="fa-regular fa-clock mr-1"></i>{{ $sportMain->created_at->format('M d, Y | H:i') }}</span>
                             </div>
                        </div>
                    </div>
                    @endif
                    ...
                    <div class="lg:col-span-4 flex flex-col gap-2">
                         ...
                         <div class="flex gap-3 p-2 border border-transparent hover:border-neutral-200 hover:bg-white transition group cursor-pointer">
                             ...
                             <div>
                                 ...
                                 <span class="text-[9px] text-neutral-500 font-sans block mt-1">{{ $sub->created_at->format('M d | H:i') }}</span>
                             </div>
                         </div>
                         @endforeach
                    </div>
                ...
                <div class="grid md:grid-cols-3 gap-6 mt-6 pt-6 border-t border-dashed border-neutral-300">
                     ...
                     <div class="group">
                         ...
                         <span class="text-[10px] text-neutral-500 font-sans mt-1 block">{{ $gridItem->created_at->format('M d, Y | H:i') }}</span>
                     </div>
                     @endforeach
                </div>
            </div>
    ...
    <section class="container mx-auto px-4 md:px-6 py-12 border-t-4 border-double border-black">
        <h2 class="text-2xl font-black font-sans uppercase mb-6 text-center">More News & Features</h2>
            ...
            <div class="lg:w-2/3">
                     ...
                     <div class="flex flex-col md:flex-row gap-6 mb-8 border-b border-black pb-8">
                         <div class="md:w-2/3 relative group">
                             ...
                             <div class="mt-4">
                                 ...
                                 <h2 class="text-2xl font-black font-serif mt-2 leading-tight group-hover:text-blue-700 transition">
                                 ...
                                 <span class="text-[9px] text-neutral-400 font-bold uppercase tracking-widest mt-2 block">{{ $mainFeature->created_at->format('M d, Y | H:i') }}</span>
                             </div>
                         </div>
                         <div class="md:w-1/3 flex flex-col gap-4">
                             ...
                             <div class="flex gap-3 items-start group">
                                 ...
                                 <div>
                                     ...
                                     <span class="text-[9px] text-neutral-500 uppercase">{{ $subPost->created_at->format('M d, Y | H:i') }}</span>
                                 </div>
                             </div>
                             @endforeach
                         </div>
                     ...
                     @if($latestPosts->isNotEmpty())
                          ...
                          <div>
                             <div class="flex items-center mb-4 border-l-4 border-blue-600 pl-3">
                                 <h3 class="font-bold font-sans uppercase text-blue-800">Technology</h3>
                             </div>
                             @php 
                          ...
                          <div>
                             <div class="flex items-center mb-4 border-l-4 border-orange-500 pl-3">
                                 <h3 class="font-bold font-sans uppercase text-orange-700">Sports</h3>
                             </div>
                             @php 
                      ...
                      @else
                         <div class="col-span-2 text-center py-12 border border-dashed border-neutral-300">
                             <p class="text-neutral-400 font-bold uppercase">Content Loading...</p>
                         </div>
                      @endif
                  </div>
             </div>
             ...
             <aside class="lg:w-1/3 space-y-8">
                 ...
                 <div class="bg-white border border-black p-5 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
                     <h3 class="font-sans-caption font-bold border-b border-black pb-2 mb-4 uppercase text-xs tracking-widest">Follow Us</h3>
                     ...
                     <div class="p-4">
                         <div x-show="tab === 'popular'" class="space-y-4">
                              ...
                              <div class="flex gap-3 items-center group">
                                  ...
                                  <div>
                                      <h5 class="text-xs font-bold font-serif leading-tight group-hover:underline"><a href="{{ route('post', $pop->slug) }}" wire:navigate>{{ $pop->title }}</a></h5>
                                      <span class="text-[9px] text-neutral-500 uppercase">{{ $pop->views }} Reads • {{ $pop->created_at->format('M d, Y | H:i') }}</span>
                                  </div>
                              </div>
                              @endforeach
                         </div>
                         <div x-show="tab === 'recent'" class="space-y-4" style="display: none;">
                              ...
                              <div class="flex gap-3 items-center group">
                                  ...
                                  <div>
                                      <h5 class="text-xs font-bold font-serif leading-tight group-hover:underline"><a href="{{ route('post', $rec->slug) }}" wire:navigate>{{ $rec->title }}</a></h5>
                                      <span class="text-[9px] text-neutral-500 uppercase">{{ $rec->created_at->format('M d, Y | H:i') }}</span>
                                  </div>
                              </div>
                              @endforeach
                         </div>
                 ...
                 <div class="border border-black bg-white p-5">
                     <h3 class="font-sans-caption font-bold border-b border-black pb-2 mb-4 uppercase text-xs tracking-widest">Categories</h3>
                     <div class="space-y-2">
    ...
    <!-- 8. NEW VISUAL STORIES (Bottom) -->
     <section class="container mx-auto px-4 md:px-6 py-12 border-t-4 border-double border-black mt-8">
        <div class="flex justify-between items-end mb-6">
            <h2 class="font-serif font-black text-3xl uppercase tracking-tight">Visual Stories</h2>
        ...
        <div class="flex overflow-x-auto gap-4 pb-4 snap-x hide-scrollbar">
            ...
            <div class="snap-center shrink-0 w-48 h-80 relative group cursor-pointer border border-black overflow-hidden bg-black">
                ...
                <div class="absolute bottom-0 left-0 w-full p-4">
                    ...
                    <h3 class="text-white font-serif font-bold leading-tight text-sm line-clamp-3 group-hover:underline">
    ...
    <section class="border-t-4 border-double border-black py-12 bg-paper-dark">
        <div class="container mx-auto px-4 md:px-6">
            <h2 class="font-sans-caption font-bold border-b border-black pb-2 mb-8 flex justify-between items-center">
                <span>In Focus</span>
            ...
            <div class="grid lg:grid-cols-12 gap-8">
                 ...
                 <div class="lg:col-span-7 relative border border-black group cursor-pointer bg-black">
                     ...
                     <div class="absolute bottom-0 left-0 w-full p-6">
                         ...
                         <h3 class="text-white font-bold text-xl md:text-4xl font-serif leading-none mb-2 shadow-black drop-shadow-md">
                         ...
                         <div class="flex items-center gap-3 text-neutral-300 text-xs font-sans uppercase tracking-widest mt-3">
                             ...
                             <span>•</span>
                             <span>{{ $focusMain->created_at->format('M d, Y') }}</span>
                         </div>
                     </div>
                 </div>
                 @endif
                 ...
                 <div class="lg:col-span-5 grid grid-cols-2 gap-4">
                     ...
                     <div class="group cursor-pointer flex flex-col h-full bg-white border border-neutral-200">
                         ...
                         <div class="p-3 flex flex-col flex-1">
                             ...
                             <span class="text-[10px] text-neutral-500 font-bold uppercase mt-3 pt-2 border-t border-neutral-100 block">
